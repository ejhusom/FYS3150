//==============================================================================
// Title:           FYS3150 Project 1 - Matrix Equation Solver
...
//                  u(0) = u(1) = 0
//
//                  This program solves the specific equation from task 1b.
//==============================================================================
#include <iostream>
#include <fstream>
#include <cmath>
...
int main()
{
    ...
    // initialize arrays
    double *a = new double[n+2];        // sub- and super-diagonal
