...
# -*- coding: utf-8 -*-
#==============================================================================
# Title:           Make project 2
# Author:          Erik Johannes B. L. G. Husom
# Date:            2018-09-21
# Version:         0.1
# Python version:  Python 3.6.4
# Description: Adapted from script made by Morten Hjorth-Jensen.
# USAGE: This python script reads from the command line the filename (its root) and
...
cmdline  = './project2.x '+filename +' ' + str(exponent)
